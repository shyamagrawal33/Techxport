...
const Landing = React.lazy(() => import('./layout/index'))
...
const ExportCreate = React.lazy(() => import('./views/export/ExportCreate'))
const ExportCreateFile = React.lazy(() => import('./views/export/ExportCreateFile'))
const ProductCreate = React.lazy(() => import('./views/products/ProductCreate'))
const CreateContacts = React.lazy(() => import('./views/contacts/CreateContact'))
const routes = [
  { path: '/', exact: true, name: 'Home' },
  { path: '/dashboard', name: 'Dashboard', element: Dashboard },
  { path: '/landing', name: 'Landing', element: Landing },
  { path: '/default', name: 'Default', element: DefaultLayout },
